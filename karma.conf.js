...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'static/js/widgets/alarm-actions-editor/alarm-actions-editor.js',
      'static/js/widgets/bdmapping_editor.js',
      'static/js/widgets/image_picker.js',
      'static/js/widgets/chosen.js',
      'static/js/widgets/create_bucket_dialog.js',
      'static/js/widgets/create-alarm-modal/create-alarm.js',
      ...
      'static/js/pages/alarms/alarm_detail.js',
      'static/js/pages/alarms/alarm_history.js',
      'static/js/pages/alarms/alarms_landing.js',
      'static/js/pages/alarms/components.js',
      ...
      'static/js/pages/cloudwatch_charts.js',
      ...
      'static/js/services/alarm-service.js',
      'static/js/services/chart-service.js',
      'static/js/services/chart-api-service.js',
      'static/js/services/metric-service.js',
      'static/js/services/scaling-groups-service.js',
      'static/js/pages/volume_snapshots.js',
      'static/js/jasmine-spec/SpecHelper.js',
      'static/js/jasmine-spec/spec_alarm_detail.js',
